" $Id: jah.vim 56 2012-12-01 21:01:23Z jheddings $
...
if !exists("g:jah_EnableDevMode")
  let g:jah_EnableDevMode = 1
endif
...
" read the corresponding configuration from devmode directory
if g:jah_EnableDevMode
  command! -nargs=1 DevMode :runtime devmode/<args>.vim
endif
